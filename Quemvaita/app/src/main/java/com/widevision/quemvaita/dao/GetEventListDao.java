 ...
 */
public class GetEventListDao extends QueryManager<GsonClass> {

    String user_id;

    public GetEventListDao(String user_id) {
...
/*l(user_id)*/
    ...
    protected Request.Builder buildRequest() {
        ...
        request.url(Constant.URL+"geteventlist").post(formBody).build();
