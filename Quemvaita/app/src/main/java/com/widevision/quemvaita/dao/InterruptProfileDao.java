 ...
 */
public class InterruptProfileDao extends QueryManager<GsonClass> {

    String user_id;

    public InterruptProfileDao(String user_id) {
...
/*l(user_id)*/
    ...
    protected Request.Builder buildRequest() {
        ...
        request.url(Constant.URL+"interruptaccount").post(formBody).build();
