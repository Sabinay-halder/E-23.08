 ...
 */
public class UnblockDao extends QueryManager<GsonClass> {

    String user_id, sender_id;

    public UnblockDao(String user_id, String sender_id) {
...
/*(user_id,block_id)*/
    ...
    protected Request.Builder buildRequest() {
        ...
        request.url(Constant.URL + "setunblockuser").post(formBody).build();
