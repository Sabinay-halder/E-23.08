 ...
 */
public class SetLikeDao extends QueryManager<GsonClass> {

    String user_id, receiver_id;

    public SetLikeDao(String user_id, String receiver_id) {
...
/*UserId,receiver_id*/
    ...
    protected Request.Builder buildRequest() {
        ...
        request.url(Constant.URL + "setlikeuser").post(formBody).build();
