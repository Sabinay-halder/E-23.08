 ...
 */
public class GetDisLikedListDao extends QueryManager<GsonClass> {

    String user_id;

    public GetDisLikedListDao(String user_id) {
...
/*l(user_id)*/
    ...
    protected Request.Builder buildRequest() {
        ...
        request.url(Constant.URL+"blockeduserlist").post(formBody).build();
