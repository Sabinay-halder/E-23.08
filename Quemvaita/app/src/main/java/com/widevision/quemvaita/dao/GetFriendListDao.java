 ...
 */
public class GetFriendListDao extends QueryManager<GsonClass> {

    String user_id;

    public GetFriendListDao(String user_id) {
...
/*l(user_id)*/
    ...
    protected Request.Builder buildRequest() {
        ...
        request.url(Constant.URL+"friendlist").post(formBody).build();
