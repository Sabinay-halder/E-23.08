 ...
 */
public class GetLikedListDao extends QueryManager<GsonClass> {

    String user_id;

    public GetLikedListDao(String user_id) {
...
/*l(user_id)*/
    ...
    protected Request.Builder buildRequest() {
        ...
        request.url(Constant.URL+"getlikeuser").post(formBody).build();
