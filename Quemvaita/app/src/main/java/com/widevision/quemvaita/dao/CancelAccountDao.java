 ...
 */
public class CancelAccountDao extends QueryManager<GsonClass> {

    String user_id;

    public CancelAccountDao(String user_id) {
...
/*l(user_id)*/
    ...
    protected Request.Builder buildRequest() {
        ...
        request.url(Constant.URL + "cancelaccount").post(formBody).build();
