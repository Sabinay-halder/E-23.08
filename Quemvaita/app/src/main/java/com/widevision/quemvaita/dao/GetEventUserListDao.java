 ...
 */
public class GetEventUserListDao extends QueryManager<GsonClass> {

    String user_id, event_id;

    public GetEventUserListDao(String user_id, String event_id) {
...
/*l(user_id)*/
    ...
    protected Request.Builder buildRequest() {
        ...
        request.url(Constant.URL + "geteventusers").post(formBody).build();
